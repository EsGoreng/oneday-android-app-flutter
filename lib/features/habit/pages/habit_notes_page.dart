// lib/pages/notes_setting_page.dart
...
import 'habit_notes_detail_page.dart';
import 'habit_notes_setting_page.dart';

class HabitNotesPage extends StatelessWidget {
  const HabitNotesPage({super.key});

  static const nameRoute = '/habit-notes-settings';

  @override
  Widget build(BuildContext context) {
    final double maxWidth = min(MediaQuery.of(context).size.width * 0.9, 540.0);
    return Consumer<HabitNotesProvider>(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            ...
                            const TopNavigationBar(title: 'Habit Notes'),
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              const Text('Notes', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 24)),
              IconButton(
                onPressed: () {
                Navigator.push(
                  context,
...
class _NotesEmptyCard extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<HabitNotesProvider>(context, listen: false);
    return StyledCard(
...
class _NotesCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => HabitNoteDetailScreen(note: note))),
      child: Column(
...
void _showAddEditNoteDialog(BuildContext context, HabitNotesProvider provider, {HabitNote? existingNote}) {
  showGeneralDialog(
    context: context,
...
class _AddEditNotePopup extends StatefulWidget {
  final HabitNotesProvider provider;
  final HabitNote? existingNote;
