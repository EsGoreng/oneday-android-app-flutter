...
import '../../../core/models/habit_notes_model.dart';
...
void _showAddEditNoteDialog(BuildContext context, {HabitNote? existingNote}) {
  showGeneralDialog(
    context: context,
...
void _showDeleteConfirmationDialog(BuildContext context, HabitNote note) {
  showGeneralDialog(
    context: context,
    barrierDismissible: true,
...
class _AddEditNotePopupState extends State<_AddEditNotePopup> {
  ...
  Future<void> _submitForm() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      final provider = context.read<HabitNotesProvider>();
...
class _DeleteConfirmationPopupState extends State<_DeleteConfirmationPopup> {
  ...
  Future<void> _handleDelete() async {
    ...
    try {
      await context.read<HabitNotesProvider>().deleteNote(widget.note.id);
      if (mounted) Navigator.of(context).pop();
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
